...
from groma.data.datasets.hico_hoi_oneshot import HICOHOIOneShotTest, collate_fn
...
def create_coco_ground_truth(dataset):
    ...
    return {
        "info": {
            "description": "HICO-DET One-Shot HOI Grounding Ground Truth",
            "version": "1.0",
            "year": 2024
        },
        "images": images,
...
def eval_model(args):
    ...
    if use_wandb:
        wandb.init(
            ...
            name=args.wandb_run_name or f"hico_hoi_oneshot_{model_short_name}_{timestamp}",
            config={
            ...
            tags=["hico", "hoi", "grounding", "one-shot"]
        )
    ...
    # Print results
    print("\n" + "=" * 70)
    print("HICO-DET One-Shot HOI Grounding Metrics")
    print("=" * 70)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="HICO-DET One-Shot HOI Grounding Evaluation")
    ...
    parser.add_argument("--wandb-project", type=str, default="hico-hoi-oneshot-eval", help="WandB project name")
