...
HICO_OBJECTS = [
    ...
    {"color": [250, 170, 30], "isknown": 0, "isthing": 1, "id": 10, "name": "traffic_light"},
    {"color": [100, 170, 30], "isknown": 0, "isthing": 1, "id": 11, "name": "fire_hydrant"},
    {"color": [220, 220, 0], "isknown": 0, "isthing": 1, "id": 13, "name": "stop_sign"},
    {"color": [175, 116, 175], "isknown": 1, "isthing": 1, "id": 14, "name": "parking_meter"},
    ...
    {"color": [78, 180, 255], "isknown": 1, "isthing": 1, "id": 37, "name": "sports_ball"},
    {"color": [0, 228, 0], "isknown": 1, "isthing": 1, "id": 38, "name": "kite"},
    {"color": [174, 255, 243], "isknown": 1, "isthing": 1, "id": 39, "name": "baseball_bat"},
    {"color": [45, 89, 255], "isknown": 0, "isthing": 1, "id": 40, "name": "baseball_glove"},
    {"color": [134, 134, 103], "isknown": 1, "isthing": 1, "id": 41, "name": "skateboard"},
    {"color": [145, 148, 174], "isknown": 0, "isthing": 1, "id": 42, "name": "surfboard"},
    {"color": [255, 208, 186], "isknown": 0, "isthing": 1, "id": 43, "name": "tennis_racket"},
    {"color": [197, 226, 255], "isknown": 1, "isthing": 1, "id": 44, "name": "bottle"},
    {"color": [171, 134, 1], "isknown": 1, "isthing": 1, "id": 46, "name": "wine_glass"},
    ...
    {"color": [209, 99, 106], "isknown": 1, "isthing": 1, "id": 58, "name": "hot_dog"},
    ...
    {"color": [163, 255, 0], "isknown": 0, "isthing": 1, "id": 64, "name": "potted_plant"},
    {"color": [119, 0, 170], "isknown": 0, "isthing": 1, "id": 65, "name": "bed"},
    {"color": [0, 182, 199], "isknown": 1, "isthing": 1, "id": 67, "name": "dining_table"},
    ...
    {"color": [219, 142, 185], "isknown": 1, "isthing": 1, "id": 77, "name": "cell_phone"},
    ...
    {"color": [201, 57, 1], "isknown": 0, "isthing": 1, "id": 88, "name": "teddy_bear"},
    {"color": [246, 0, 122], "isknown": 0, "isthing": 1, "id": 89, "name": "hair_drier"},
...
HICO_INTERACTIONS = [
    ...
    {'action': 'clean', 'object': 'dining_table', 'interaction_id': 107},
    {'action': 'eat_at', 'object': 'dining_table', 'interaction_id': 108},
    {'action': 'sit_at', 'object': 'dining_table', 'interaction_id': 109},
    {'action': 'no_interaction', 'object': 'dining_table', 'interaction_id': 110},
    ...
    {'action': 'carry', 'object': 'potted_plant', 'interaction_id': 170},
    {'action': 'hold', 'object': 'potted_plant', 'interaction_id': 171},
    {'action': 'hose', 'object': 'potted_plant', 'interaction_id': 172},
    {'action': 'no_interaction', 'object': 'potted_plant', 'interaction_id': 173},
    ...
    {'action': 'break', 'object': 'baseball_bat', 'interaction_id': 224},
    {'action': 'carry', 'object': 'baseball_bat', 'interaction_id': 225},
    {'action': 'hold', 'object': 'baseball_bat', 'interaction_id': 226},
    {'action': 'sign', 'object': 'baseball_bat', 'interaction_id': 227},
    {'action': 'swing', 'object': 'baseball_bat', 'interaction_id': 228},
    {'action': 'throw', 'object': 'baseball_bat', 'interaction_id': 229},
    {'action': 'wield', 'object': 'baseball_bat', 'interaction_id': 230},
    {'action': 'no_interaction', 'object': 'baseball_bat', 'interaction_id': 231},
    {'action': 'hold', 'object': 'baseball_glove', 'interaction_id': 232},
    {'action': 'wear', 'object': 'baseball_glove', 'interaction_id': 233},
    {'action': 'no_interaction', 'object': 'baseball_glove', 'interaction_id': 234},
    ...
    {'action': 'carry', 'object': 'cell_phone', 'interaction_id': 283},
    {'action': 'hold', 'object': 'cell_phone', 'interaction_id': 284},
    {'action': 'read', 'object': 'cell_phone', 'interaction_id': 285},
    {'action': 'repair', 'object': 'cell_phone', 'interaction_id': 286},
    {'action': 'talk_on', 'object': 'cell_phone', 'interaction_id': 287},
    {'action': 'text_on', 'object': 'cell_phone', 'interaction_id': 288},
    {'action': 'no_interaction', 'object': 'cell_phone', 'interaction_id': 289},
    ...
    {'action': 'hug', 'object': 'fire_hydrant', 'interaction_id': 325},
    {'action': 'inspect', 'object': 'fire_hydrant', 'interaction_id': 326},
    {'action': 'open', 'object': 'fire_hydrant', 'interaction_id': 327},
    {'action': 'paint', 'object': 'fire_hydrant', 'interaction_id': 328},
    {'action': 'no_interaction', 'object': 'fire_hydrant', 'interaction_id': 329},
    ...
    {'action': 'hold', 'object': 'hair_drier', 'interaction_id': 348},
    {'action': 'operate', 'object': 'hair_drier', 'interaction_id': 349},
    {'action': 'repair', 'object': 'hair_drier', 'interaction_id': 350},
    {'action': 'no_interaction', 'object': 'hair_drier', 'interaction_id': 351},
    ...
    {'action': 'carry', 'object': 'hot_dog', 'interaction_id': 356},
    {'action': 'cook', 'object': 'hot_dog', 'interaction_id': 357},
    {'action': 'cut', 'object': 'hot_dog', 'interaction_id': 358},
    {'action': 'eat', 'object': 'hot_dog', 'interaction_id': 359},
    {'action': 'hold', 'object': 'hot_dog', 'interaction_id': 360},
    {'action': 'make', 'object': 'hot_dog', 'interaction_id': 361},
    {'action': 'no_interaction', 'object': 'hot_dog', 'interaction_id': 362},
    ...
    {'action': 'check', 'object': 'parking_meter', 'interaction_id': 414},
    {'action': 'pay', 'object': 'parking_meter', 'interaction_id': 415},
    {'action': 'repair', 'object': 'parking_meter', 'interaction_id': 416},
    {'action': 'no_interaction', 'object': 'parking_meter', 'interaction_id': 417},
    ...
    {'action': 'block', 'object': 'sports_ball', 'interaction_id': 488},
    {'action': 'carry', 'object': 'sports_ball', 'interaction_id': 489},
    {'action': 'catch', 'object': 'sports_ball', 'interaction_id': 490},
    {'action': 'dribble', 'object': 'sports_ball', 'interaction_id': 491},
    {'action': 'hit', 'object': 'sports_ball', 'interaction_id': 492},
    {'action': 'hold', 'object': 'sports_ball', 'interaction_id': 493},
    {'action': 'inspect', 'object': 'sports_ball', 'interaction_id': 494},
    {'action': 'kick', 'object': 'sports_ball', 'interaction_id': 495},
    {'action': 'pick_up', 'object': 'sports_ball', 'interaction_id': 496},
    {'action': 'serve', 'object': 'sports_ball', 'interaction_id': 497},
    {'action': 'sign', 'object': 'sports_ball', 'interaction_id': 498},
    {'action': 'spin', 'object': 'sports_ball', 'interaction_id': 499},
    {'action': 'throw', 'object': 'sports_ball', 'interaction_id': 500},
    {'action': 'no_interaction', 'object': 'sports_ball', 'interaction_id': 501},
    {'action': 'hold', 'object': 'stop_sign', 'interaction_id': 502},
    {'action': 'stand_under', 'object': 'stop_sign', 'interaction_id': 503},
    {'action': 'stop_at', 'object': 'stop_sign', 'interaction_id': 504},
    {'action': 'no_interaction', 'object': 'stop_sign', 'interaction_id': 505},
    ...
    {'action': 'carry', 'object': 'teddy_bear', 'interaction_id': 528},
    {'action': 'hold', 'object': 'teddy_bear', 'interaction_id': 529},
    {'action': 'hug', 'object': 'teddy_bear', 'interaction_id': 530},
    {'action': 'kiss', 'object': 'teddy_bear', 'interaction_id': 531},
    {'action': 'no_interaction', 'object': 'teddy_bear', 'interaction_id': 532},
    {'action': 'carry', 'object': 'tennis_racket', 'interaction_id': 533},
    {'action': 'hold', 'object': 'tennis_racket', 'interaction_id': 534},
    {'action': 'inspect', 'object': 'tennis_racket', 'interaction_id': 535},
    {'action': 'swing', 'object': 'tennis_racket', 'interaction_id': 536},
    {'action': 'no_interaction', 'object': 'tennis_racket', 'interaction_id': 537},
    ...
    {'action': 'install', 'object': 'traffic_light', 'interaction_id': 562},
    {'action': 'repair', 'object': 'traffic_light', 'interaction_id': 563},
    {'action': 'stand_under', 'object': 'traffic_light', 'interaction_id': 564},
    {'action': 'stop_at', 'object': 'traffic_light', 'interaction_id': 565},
    {'action': 'no_interaction', 'object': 'traffic_light', 'interaction_id': 566},
    ...
    {'action': 'fill', 'object': 'wine_glass', 'interaction_id': 588},
    {'action': 'hold', 'object': 'wine_glass', 'interaction_id': 589},
    {'action': 'sip', 'object': 'wine_glass', 'interaction_id': 590},
    {'action': 'toast', 'object': 'wine_glass', 'interaction_id': 591},
    {'action': 'lick', 'object': 'wine_glass', 'interaction_id': 592},
    {'action': 'wash', 'object': 'wine_glass', 'interaction_id': 593},
    {'action': 'no_interaction', 'object': 'wine_glass', 'interaction_id': 594},
