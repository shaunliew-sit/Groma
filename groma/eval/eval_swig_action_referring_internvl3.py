"""
SWIG-HOI Action Referring Evaluation Script for InternVL3
...
Usage:
    python groma/eval/eval_swig_action_referring_internvl3.py \
...
def eval_model(args):
    ...
    print("=" * 80)
    print("SWIG-HOI Action Referring Evaluation (InternVL3)")
    print("=" * 80)
    ...
    if use_wandb:
        ...
        try:
            ...
            wandb.init(
                ...
                name=args.wandb_run_name or f"swig_action_internvl3_{timestamp}",
                config={
                ...
                tags=["swig", "action-referring", "internvl3", "person-person"]
            )
    ...
    for idx, sample in enumerate(tqdm(dataset_samples, disable=show_verbose)):
        ...
        if not object_category or object_category == 'object':
            # For SWIG, actions are formatted as "action_ing object"
    ...
    # Print results
    print("\n" + "=" * 80)
    print("SWIG-HOI Action Referring Results (InternVL3)")
    print("=" * 80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SWIG-HOI Action Referring Evaluation with InternVL3")
    ...
    parser.add_argument("--wandb-project", type=str, default="swig-action-referring-internvl3",
