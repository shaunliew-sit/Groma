...
datasets = [
    ...
    {
        'type': 'hico_ground',
        'ann_file': '/workspace/Groma/groma_data/benchmarks/hico_ground_train.json',
    ...
    # ========================================================================
    {
        ...
        'ann_file': '/workspace/Groma/groma_data/benchmarks/hico_action_referring_train.json',
        'img_prefix': '../data/hico_20160224_det/images/train2015',
        'conv_temp': 'llava'
    },
    ...
    {
        'type': 'swig_ground',
        'ann_file': '/workspace/Groma/groma_data/benchmarks/swig_ground_train.json',
    ...
    # ========================================================================
    {
        ...
        'ann_file': '/workspace/Groma/groma_data/benchmarks/swig_action_referring_train.json',
        'img_prefix': '../data/swig_hoi/images_512',
        'conv_temp': 'llava'
    },
]
