...
# Updated to request "action and target" to match new training format
ACTION_REFERRING_TEMPLATES = [
    "What is {} doing with {}? Answer with action and target:",
    "Describe the action and target for {} interacting with {}:",
    "What action is {} performing with {}? Include action and object:",
    "How is {} interacting with {}? State action and target:",
]
