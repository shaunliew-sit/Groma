#!/bin/bash
################################################################################
# [GROMA-QWEN V2] HICO-DET Grounding Task Evaluation Script (JSON Format)
...
#
# Usage:
#   bash scripts/run_hico_ground_groma_qwen_v2_eval.sh [GPU] [MODEL] [OUTPUT_DIR]
#
# Examples:
#   # Basic usage
#   bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 0
#   bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 1
#
#   # With optional flags (set as environment variables)
#   VERBOSE=1 bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 0
#   MAX_IMAGES=10 bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 0
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 4
#
#   # With Weights & Biases logging
#   WANDB=1 VERBOSE=1 bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 4
#   WANDB=1 WANDB_PROJECT="my-hoi-eval" bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 0
#   WANDB=1 WANDB_PROJECT="my-project" WANDB_RUN_NAME="test-run" bash scripts/run_hico_ground_groma_qwen_v2_eval.sh 0
#
...
#
# Output files:
#   {output_dir}/hico_ground_v2_{timestamp}.json                    # Raw predictions
#   {output_dir}/hico_ground_v2_{timestamp}_per_image.json          # Detailed (VERBOSE)
#   {output_dir}/hico_ground_v2_{timestamp}_metrics.json            # AR metrics
#   {output_dir}/hico_ground_v2_{timestamp}_action_stats.json       # Per-action stats
#   {output_dir}/hico_ground_v2_{timestamp}.log                     # Full log
################################################################################
...
OUTPUT_DIR="${4:-results-groma-qwen/hico_ground_v2_grounding_json}"
...
LOG_FILE="$OUTPUT_DIR/hico_ground_v2_${TIMESTAMP}.log"
...
RESULT_FILE="${OUTPUT_DIR}/hico_ground_v2_${TIMESTAMP}.json"
...
echo "========================================================================"
echo "[GROMA-QWEN V2] HICO-DET Grounding Evaluation (JSON Format)"
echo "========================================================================"
echo "GPU:         $GPU_ID"
