...
NUM_GPUS=${4:-8}
RUN_NAME=${5:-"vl-finetune-hoi-$(date +%Y%m%d-%H%M%S)"}
...
# WandB configuration
WANDB_PROJECT=${WANDB_PROJECT:-"groma-instruction-finetune-hoi"}
...
CUDA_VISIBLE_DEVICES=$GPU_IDS torchrun \
    ...
    --dataset_config groma/data/configs/vl_finetune_hoi_only.py \
