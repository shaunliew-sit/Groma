...
#   MAX_IMAGES=10 bash scripts/run_swig_ground_eval_qwen3vl.sh 0      # Test on first 10 images
...
#   bash scripts/run_swig_ground_eval_qwen3vl.sh 0 "Qwen/Qwen3-VL-32B-Instruct"
#
...
OUTPUT_DIR="${3:-results/swig_ground_qwen3vl}"
