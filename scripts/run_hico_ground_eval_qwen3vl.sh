...
#   bash scripts/run_hico_ground_eval_qwen3vl.sh 0                    # Use GPU 0
#   bash scripts/run_hico_ground_eval_qwen3vl.sh 1                    # Use GPU 1
#   bash scripts/run_hico_ground_eval_qwen3vl.sh cuda:0               # Explicit cuda:0
#
...
#   VERBOSE=1 WANDB=1 bash scripts/run_hico_ground_eval_qwen3vl.sh 1 "Qwen/Qwen3-VL-8B-Thinking"      # Test on first 10 images
...
OUTPUT_DIR="${3:-results-redo/hico_ground_qwen3vl_8B_thinking}"
...
EVAL_CMD="python3 groma/eval/eval_hico_ground_qwen3vl.py \
