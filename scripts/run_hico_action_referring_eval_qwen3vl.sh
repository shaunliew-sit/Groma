...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_hico_action_referring_eval_qwen3vl.sh 1  # Both flags
#
#   # With Weights & Biases logging
#   WANDB=1 VERBOSE=1 bash scripts/run_hico_action_referring_eval_qwen3vl.sh 1            # Enable WandB
...
#   bash scripts/run_hico_action_referring_eval_qwen3vl.sh 0 "Qwen/Qwen3-VL-32B-Instruct"   # Larger instruct model
#   bash scripts/run_hico_action_referring_eval_qwen3vl.sh 0 "Qwen/Qwen3-VL-8B-Thinking"    # Thinking model
#
...
#
# Output files:
#   {output_dir}/hico_action_qwen3vl_results_{timestamp}.json          # Raw predictions (includes thinking_content field)
...
#   {output_dir}/hico_action_qwen3vl_results_{timestamp}_thinking.jsonl # Thinking process (thinking models only)
