...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_hico_action_referring_eval_internvl3.sh 1  # Both flags
#
#   # With Weights & Biases logging
#   WANDB=1 VERBOSE=1 bash scripts/run_hico_action_referring_eval_internvl3.sh 7            # Enable WandB
...
OUTPUT_DIR="${3:-results-redo/hico_action_internvl3-38B}"
