...
#
#   # With W&B logging
#   WANDB=1 VERBOSE=1 bash scripts/run_swig_action_referring_groma_qwen_v2_eval.sh 0
...
GPU_ID="${1:-0}"
MODEL_PATH="${2:-checkpoints/groma-qwen-v2-stage2-referring-new}"
...
OUTPUT_DIR="${4:-results-groma-qwen/swig_action_referring_v2}"
