#!/bin/bash
################################################################################
# [GROMA-QWEN V3] SWIG-HOI Action Referring Evaluation Script
...
#
# Usage:
#   bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh [GPU] [MODEL] [BASE_MODEL] [OUTPUT_DIR]
#
# Examples:
#   # V3 model evaluation
#   bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 0 checkpoints/groma-qwen-v3-referring
#
#   # V2 model (auto-detected)
#   bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 0 checkpoints/groma-qwen-v2-stage2
#
#   # With debugging flags
#   VERBOSE=1 bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 0
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 6
#
#   # With W&B logging
#   WANDB=1 VERBOSE=1 bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 6
#   WANDB=1 WANDB_PROJECT="my-project" bash scripts/run_swig_action_referring_groma_qwen_v3_eval.sh 0
#
...
#
# Output files:
#   {output_dir}/swig_action_v3_{timestamp}.json              # Raw predictions
#   {output_dir}/swig_action_v3_{timestamp}_per_triplet.json  # Per-triplet (VERBOSE)
#   {output_dir}/swig_action_v3_{timestamp}_per_action.json   # Per-action (VERBOSE)
#   {output_dir}/swig_action_v3_{timestamp}_metrics.json      # METEOR/CIDEr scores
#   {output_dir}/swig_action_v3_{timestamp}.log               # Full log
################################################################################
...
OUTPUT_DIR="${4:-results-groma-qwen/swig_action_referring_v3}"
...
LOG_FILE="$OUTPUT_DIR/swig_action_v3_${TIMESTAMP}.log"
PRED_FILE="$OUTPUT_DIR/swig_action_v3_${TIMESTAMP}.json"

echo "========================================================================"
echo "[GROMA-QWEN V3] SWIG-HOI Action Referring Evaluation"
echo "========================================================================"
echo "GPU:          $GPU_ID"
