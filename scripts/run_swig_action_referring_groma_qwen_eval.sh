#!/bin/bash
################################################################################
# [GROMA-QWEN] SWIG-HOI Action Referring Task Evaluation Script for Groma Qwen3VL
...
#
# Usage:
#   bash scripts/run_swig_action_referring_groma_qwen_eval.sh [GPU] [MODEL] [OUTPUT_DIR]
#
# Examples:
#   # Basic usage
...
#   VERBOSE=1 bash scripts/run_swig_action_referring_groma_qwen_eval.sh 0
#   MAX_IMAGES=10 bash scripts/run_swig_action_referring_groma_qwen_eval.sh 0
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_action_referring_groma_qwen_eval.sh 5
#
#   # With W&B logging
#   WANDB=1 VERBOSE=1 bash scripts/run_swig_action_referring_groma_qwen_eval.sh 5
...
#   WANDB_PROJECT     W&B project name (default: swig-action-referring-groma-qwen)
...
#
# Output files:
#   {output_dir}/swig_action_groma_qwen_results_{timestamp}.json         # Raw predictions
#   {output_dir}/swig_action_groma_qwen_results_{timestamp}_per_triplet.json  # Detailed per-triplet (VERBOSE) with METEOR/CIDEr scores
#   {output_dir}/swig_action_groma_qwen_results_{timestamp}_per_action.json   # Per-action breakdown (VERBOSE)
#   {output_dir}/swig_action_groma_qwen_results_{timestamp}_metrics.json      # METEOR/CIDEr scores
#   {output_dir}/swig_action_groma_qwen_evaluation_{timestamp}.log                # Full log
...
LOG_FILE="$OUTPUT_DIR/swig_action_groma_qwen_evaluation_${TIMESTAMP}.log"
PRED_FILE="$OUTPUT_DIR/swig_action_groma_qwen_results_${TIMESTAMP}.json"
METRICS_FILE="$OUTPUT_DIR/swig_action_groma_qwen_results_${TIMESTAMP}_metrics.json"
...
echo "========================================================================"
echo "SWIG-HOI Action Referring Evaluation (Groma Qwen3VL) - METEOR & CIDEr"
echo "========================================================================"
echo "GPU:         $GPU_ID"
...
python3 groma/eval/eval_swig_action_referring_groma_qwen.py \
