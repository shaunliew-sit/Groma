#!/bin/bash
################################################################################
# [GROMA-QWEN V2] HICO-DET Action Referring Evaluation Script
...
#
# Usage:
#   bash scripts/run_hico_action_referring_groma_qwen_v2_eval.sh [GPU] [MODEL] [OUTPUT_DIR]
#
# Examples:
#   # Basic usage
#   bash scripts/run_hico_action_referring_groma_qwen_v2_eval.sh 0
#
#   # With custom model
#   bash scripts/run_hico_action_referring_groma_qwen_v2_eval.sh 0 checkpoints/groma-qwen-v2-stage2
#
...
#
# Output files:
#   {output_dir}/hico_action_v2_{timestamp}.json              # Raw predictions
#   {output_dir}/hico_action_v2_{timestamp}_per_triplet.json  # Per-triplet (VERBOSE)
#   {output_dir}/hico_action_v2_{timestamp}_per_action.json   # Per-action (VERBOSE)
#   {output_dir}/hico_action_v2_{timestamp}_metrics.json      # METEOR/CIDEr scores
#   {output_dir}/hico_action_v2_{timestamp}.log               # Full log
################################################################################
...
LOG_FILE="$OUTPUT_DIR/hico_action_v2_${TIMESTAMP}.log"
PRED_FILE="$OUTPUT_DIR/hico_action_v2_${TIMESTAMP}.json"

echo "========================================================================"
echo "[GROMA-QWEN V2] HICO-DET Action Referring Evaluation"
echo "========================================================================"
echo "GPU:          $GPU_ID"
