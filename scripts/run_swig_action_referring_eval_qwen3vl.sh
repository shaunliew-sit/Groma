...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_action_referring_eval_qwen3vl.sh 0  # Both flags
#
...
#   bash scripts/run_swig_action_referring_eval_qwen3vl.sh 0 "Qwen/Qwen3-VL-32B-Instruct"
#
...
#
# Output files:
#   {output_dir}/swig_action_qwen3vl_results_{timestamp}.json          # Raw predictions
...
OUTPUT_DIR="${3:-results/swig_action_qwen3vl}"
