...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_hico_ground_eval.sh 1  # Both flags
#
#   # With Weights & Biases logging
#   WANDB=1 bash scripts/run_hico_ground_eval.sh 0            # Enable WandB logging
#   WANDB=1 VERBOSE=1 MAX_IMAGES=10 bash scripts/run_hico_ground_eval.sh 1  # Full debug + WandB
#   WANDB=1 VERBOSE=1 bash scripts/run_hico_ground_eval.sh 1  # Full debug + WandB
...
OUTPUT_DIR="${3:-results-redo-groma/hico_ground}"
