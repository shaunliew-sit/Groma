...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_hoi_oneshot_eval.sh 5  # Both flags
#
#   # With Weights & Biases logging
#   WANDB=1 bash scripts/run_swig_hoi_oneshot_eval.sh 0            # Enable WandB logging
#   WANDB=1 VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_hoi_oneshot_eval.sh 5  # Full debug + WandB
#   WANDB=1 VERBOSE=1 bash scripts/run_swig_hoi_oneshot_eval.sh 5  # Full debug + WandB + full run
