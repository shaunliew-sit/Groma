...
#   VERBOSE=1 MAX_IMAGES=10 bash scripts/run_swig_action_referring_eval.sh 1
#
#   # With W&B logging
#   WANDB=1 VERBOSE=1 bash scripts/run_swig_action_referring_eval.sh 1
...
OUTPUT_DIR="${5:-results-redo-groma/swig_action_referring}"
